...
namespace ApkReader.Utils
{
    ...
    internal class BoundedStream : Stream
    {
        ...
        {
            get { return _source.Position - SourceOrigin; }
        ...
        public override long Seek(long offset, SeekOrigin origin)
        {
            ...
            switch (origin)
            {
                ...
                case SeekOrigin.Current:
                    absoluteOffset = _source.Position - SourceOrigin + offset;
                    break;
                case SeekOrigin.End:
            ...
            if (absoluteOffset < 0 || absoluteOffset >= _length)
            {
                throw new ArgumentOutOfRangeException(nameof(offset));
            }
            return _source.Seek(SourceOrigin + absoluteOffset, SeekOrigin.Begin) - SourceOrigin;
        }
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            var finalPosition = _source.Position - SourceOrigin + count;
