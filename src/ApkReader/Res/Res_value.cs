...
namespace ApkReader.Res
{
    ...
    public class Res_value
    {
        ...
        /// <summary>
        ///     Gets or sets the data as a resource reference. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_REFERENCE" />.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Gets or sets the data as a string reference. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_STRING" />.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     Gets or sets the data as a floating point value. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_FLOAT" />.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the data as a signed integer value. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_INT_DEC" />
        ...
        /// <summary>
        ///     Gets or sets the <see cref="ColorValue" /> as a <see cref="Color" />.
        /// </summary>
        public Color DrawingColorValue
        {
            get
            {
        ...
        /// <summary>
        ///     Gets or sets the data as a color value. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_INT_COLOR_ARGB4" />,
        ...
        public Color ColorValue
        {
            get
            {
                var bytes = BitConverter.GetBytes(RawData);
        ...
        /// <summary>
        ///     Gets or sets the unit of the data as a dimension value. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_DIMENSION" />.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the unit of the data as a fraction value. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_FRACTION" />.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the number of the data as a complex value. Used when <see cref="DataType" /> is
        ///     <see cref="ValueType.TYPE_DIMENSION" />
