...
namespace ApkReader.Res
{
    ...
    public class ResTable_config
    {
        ...
        {
            get => (ConfigKeysHidden) Helper.GetBits(InputFlags, (byte) 0x3u, (byte) 0);
            set => InputFlags = Helper.SetBits(InputFlags, (byte) value, (byte) 0x3u, (byte) 0);
        }

        public ConfigNavHidden InputNavHidden
        {
            get => (ConfigNavHidden) Helper.GetBits(InputFlags, 0xc, (byte) 0x2);
            set => InputFlags = Helper.SetBits(InputFlags, (byte) value, 0xc, (byte) 0x2);
        }
        ...
        {
            get => (ConfigScreenSize) Helper.GetBits(ScreenConfigScreenLayout, 0x0f, (byte) 0);
            set => ScreenConfigScreenLayout = Helper.SetBits(ScreenConfigScreenLayout, (byte) value, 0x0f, (byte) 0);
        }

        public ConfigScreenLong ScreenConfigScreenLong
        {
            get => (ConfigScreenLong) Helper.GetBits(ScreenConfigScreenLayout, 0x30, (byte) 0x04);
            set => ScreenConfigScreenLayout = Helper.SetBits(ScreenConfigScreenLayout, (byte) value, 0x30, (byte) 0x04);
        }

        public ConfigScreenLayoutDirection ScreenConfigLayoutDirection
        {
            get => (ConfigScreenLayoutDirection) Helper.GetBits(ScreenConfigScreenLayout, 0xc0, (byte) 0x6);
            set => ScreenConfigScreenLayout = Helper.SetBits(ScreenConfigScreenLayout, (byte) value, 0xc0, (byte) 0x6);
        }

        public ConfigUIModeType ScreenConfigUIModeType
        {
            get => (ConfigUIModeType) Helper.GetBits(ScreenConfigUIMode, 0x0f, (byte) 0x00);
        ...
        {
            get => (ConfigUIModeNight) Helper.GetBits(ScreenConfigUIMode, (byte) 0x3u, (byte) 0x04);
