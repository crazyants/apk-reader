...
namespace ApkReader.Run
{
    public class AndroidXmlReader : XmlReader
    {
        ...
        /// <summary>
        ///     Gets the value of the attribute with the specified <see cref="P:System.Xml.XmlReader.LocalName" /> and
        ...
        {
            if (_parser.EventCode != ResXmlParser.XmlParserEventCode.StartTag)
            {
                return null;
            }
        ...
        ///     <paramref name="i" /> is out of range. It must be non-negative
        ///     and less than the size of the attribute collection.
        /// </exception>
        ...
        /// <summary>
        ///     Moves to the attribute with the specified <see cref="P:System.Xml.XmlReader.LocalName" /> and
        ///     <see cref="P:System.Xml.XmlReader.NamespaceURI" />.
        /// </summary>
        /// <returns>
        ///     true if the attribute is found; otherwise, false. If false, the reader's position does not change.
        ...
        /// </summary>
        /// <returns>
        ///     true if an attribute exists (the reader moves to the first attribute); otherwise, false (the position of the reader
        ///     does not change).
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     true if the reader is positioned on an attribute (the reader moves to the element that owns the attribute); false
        ...
        /// </summary>
        /// <returns>
        ///     true if there are nodes to return.false if the reader is not positioned on an attribute node when the initial call
        ///     is made or if all the attribute values have been read.An empty attribute, such as, misc="", returns true with a
        ...
        /// </returns>
        /// <param name="prefix">
        ///     The prefix whose namespace URI you want to resolve. To match the default namespace, pass an empty
        ///     string.
        /// </param>
        ...
        ///     The reader is not positioned on an EntityReference node; this
        ///     implementation of the reader cannot resolve entities (<see cref="P:System.Xml.XmlReader.CanResolveEntity" />
        ///     returns false).
        /// </exception>
        ...
        /// </summary>
        /// <returns>
        ///     The value returned depends on the <see cref="P:System.Xml.XmlReader.NodeType" /> of the node. The following table
        ///     lists node types that have a value to return. All other node types return String.Empty.Node type Value AttributeThe
        ///     value of the attribute. CDATAThe content of the CDATA section. CommentThe content of the comment. DocumentTypeThe
        ///     internal subset. ProcessingInstructionThe entire content, excluding the target. SignificantWhitespaceThe white
        ///     space between markup in a mixed content model. TextThe content of the text node. WhitespaceThe white space between
        ///     markup. XmlDeclarationThe content of the declaration.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     true if the current node is an element (<see cref="P:System.Xml.XmlReader.NodeType" /> equals XmlNodeType.Element)
